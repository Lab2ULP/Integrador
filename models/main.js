...
Agenda.belongsTo(ProfesionalEspecialidad, {
  foreignKey: "prof_especialidadID",
});
...
Profesional.belongsTo(Persona, { foreignKey: "personaID" });
ProfesionalDiasNoLaborables.belongsTo(Profesional, {
  foreignKey: "profesionalID",
});
ProfesionalDiasNoLaborables.belongsTo(DiasNoLaborables, {
